...
1. **Apa sebenarnya akal imitasi?** — model statistik, *agentic AI*, dan *embodied AI*
2. **Bagaimana orang memakai AI?** Bukti dari riset
3. **Pengantar *AI Fluency Framework*** — mengapa *fluency* menentukan kualitas *output*
4. **Kesimpulan** dan *take-away message* dari saya
...
::: {.incremental}
1. Menggunakan AI *chatbot* (mis. ChatGPT, Claude, Gemini, Copilot, Kimi, DeepSeek, dll.) minimal sekali
2. Menggunakannya untuk tugas-tugas yang berkaitan dengan perkuliahan atau pekerjaan
3. Menggunakannya untuk urusan **di luar** kuliah dan pekerjaan (mis. minta resep masakan, curhat, menyusun rencana liburan, dsb.)
4. Pernah **mendapati** AI memberikan **jawaban yang salah**, tapi nada jawabannya sangat meyakinkan
:::
...
* Paralelisme inilah yang memungkinkan pelatihan model yang jauh lebih besar (mis. [Kimi 3 dengan 2,8 triliun parameter](https://www.kimi.com/blog/kimi-k3))
:::
:::
...
2. ***Fine-tuning*** (termasuk [*reinforcement learning from human feedback*, RLHF](https://en.wikipedia.org/wiki/Reinforcement_learning_from_human_feedback)) — model dilatih mengikuti instruksi, menjawab dengan sopan, dan menolak permintaan yang tidak patut, apalagi berbahaya
...
*Pre-training* ≈ pemerolehan bahasa dan pengetahuan; *fine-tuning* ≈ sosialisasi, yaitu belajar norma tentang *bagaimana* menggunakan kemampuan itu.
:::
...
Gabungan ketiganya memunculkan fenomena *emergent capabilities*, yaitu kemampuan yang muncul begitu saja setelah model melewati ukuran tertentu, tanpa pernah diprogram secara eksplisit (menerjemahkan, menulis kode, penalaran berantai...)
:::
...
* ***Reasoning models*** — "berpikir" langkah demi langkah dulu sebelum menjawab (mis. model-model "*frontier*" seperti Opus 5, Kimi 3, GPT-5.6 Sol, Fable 5, dsb.)
...
Kemampuan berkolaborasi dengan AI akan menjadi keterampilan dasar, seperti halnya literasi digital.
:::
...
* Manfaat utamanya: ***decision support*** 
...
::: {.incremental}
* Dua topik terbesar: ***productivity & workflow*** dan ***learning & research***, total **57%** dari seluruh *query*
...
## Mengapa perlu belajar sekarang

**Pesan saya untuk Anda** sebagai mahasiswa magister psikologi:

::: {.incremental}

* AI sudah jadi bagian dari infrastruktur akademik; pertanyaannya tinggal *bagaimana* memakainya dengan **efektif, efisien, etis, dan aman**
* Pelajari sekarang, **selagi alatnya masih relatif murah dan sederhana**
...
Bagian awal presentasi tadi fokusnya adalah *literacy*; sisa sesi ini membahas *fluency*.
:::

::: {.callout-note}
### Definisi *AI fluency*

Kemampuan berkolaborasi dengan AI secara **efektif, efisien, etis, dan aman** ([Bent et al., 2026](https://anthropic.skilljar.com/ai-fluency-framework-foundations)).
:::
...
* Pengguna fasih bersikap ***augmentative*** dalam kolaborasi: berulang kali menyempurnakan, mempertajam tujuan, dan mengkritisi *output*
* Sebaliknya, pengguna pemula bersikap **pasif**: menerima begitu saja rencana dan jawaban AI
:::

::: {.fragment}
**Paradoksnya:** pengguna fasih justru mengalami **lebih banyak kegagalan** (misalnya menolak *output* AI), tapi kegagalan mereka *visible*, karena mereka aktif memeriksa, dan lebih sering berujung pada perbaikan *output*. 

**Kegagalan pemula justru *invisible***. Artinya, percakapan tampak berhasil memberi jawaban, padahal hasilnya meleset dan tidak koheren sama sekali.
:::
...
[Bent et al., 2026](https://anthropic.skilljar.com/ai-fluency-framework-foundations) mengidentifikasi tiga cara kita melibatkan AI:
...
::: {.fragment}
Riset menunjukkan mode yang paling produktif untuk pekerja pengetahuan adalah ***augmentation***, yaitu AI sebagai mitra berpikir (*thought partner*) ([Potts & Sudhof, 2026](http://arxiv.org/abs/2604.25905)).
:::
...
Materi 4D diadaptasi dari kursus *AI Fluency: Framework & Foundations*, [Bent et al., 2026](https://anthropic.skilljar.com/ai-fluency-framework-foundations).
:::
...
Komunikasikan dan evaluasi *output* AI, meskipun Anda menolak *output* dari percakapan tersebut. Jelaskan alasannya supaya AI bisa menyesuaikan *output* berikutnya dalam percakapan yang sama.
:::
...
Perhatikan batasan ini: jangan mengarang referensi yang tidak pernah ada. Kalau tidak yakin, terbuka saja bilang tidak yakin. Kalau konteks dari saya masih kurang detail,
berikan pertanyaan sebelum mulai tugasnya. Jangan selalu setuju dengan argumen saya; berperanlah sebagai devil's advocate.
```
...
::: {.fragment}
*Description* dan *discernment* lalu membentuk *feedback loop*: *describe* → *discern* → perbaiki deskripsi → *discern* lagi... sampai hasilnya benar-benar sesuai dengan standar Anda. 
:::
...
* Pengguna yang lebih fasih berkolaborasi dengan AI lebih sering *menemukan* kegagalan karena mereka **aktif mencarinya**
:::
...
* ***Cognitive offloading*** — "menitipkan" proses berpikir ke alat bantu. 
  ...
  + Tapi keterampilan yang tidak pernah dilatih, tanpa friksi sama sekali, lama-lama akan hilang (*deskilling*/*skill decay*; [Cash et al., 2026](https://linkinghub.elsevier.com/retrieve/pii/S1364661326001312))
...
Tanpa *expertise*, keempat syarat tadi sulit dipenuhi dan AI kembali menjadi "jin dalam botol"🧞.
:::
...
::: {.incremental}
* **Jangan pernah** mengunggah data partisipan yang bisa diidentifikasi (transkrip wawancara, data mentah beridentitas) ke sistem AI yang kebijakan privasi/pengelolaan datanya tidak Anda ketahui dengan pasti 
  + Ini pelanggaran etika penelitian
* Periksa dulu apakah sistem AI yang Anda pakai menggunakan *input* Anda untuk melatih modelnya
* Pikirkan dua kali sebelum mengunggah dokumen-dokumen berikut ini ke sistem AI: naskah yang belum terbit, ide penelitian yang belum dibuat publik, dokumen internal institusi
* Pilihan yang lebih aman: anonimkan dulu, pakai data sintetis untuk contoh, atau pilih sistem AI dengan jaminan privasi data pengguna yang jelas
:::
...
::: {.incremental}
* Kuncinya: jangan menerima *output* AI secara pasif. Keterlibatan aktif inilah yang membedakan AI sebagai *asisten* dari AI sebagai "jin botol"🧞 ([Potts & Sudhof, 2026](http://arxiv.org/abs/2604.25905))
* *Domain expertise* Anda yang membuat Anda sulit digantikan AI; makin mahir Anda sebagai ilmuwan psikologi, makin baik kolaborasi Anda dengan AI
:::

::: {.fragment}
Pertanyaan untuk dibawa pulang: di bagian mana dari studi magister Anda, AI paling berisiko membuat Anda berhenti berpikir sendiri?
