...
* Padahal yang sebenarnya terjadi: ia adalah model statistik dengan *output* teks ("*large language model*") yang **meniru** produk kognisi manusia ("bahasa natural")
...
* **2010-an** — *deep learning*: jaringan saraf tiruan berlapis-lapis; terobosan besar dalam pengenalan gambar dan suara (*natural language processing*, NLP)
...
* ***Reasoning models*** — "berpikir" langkah demi langkah dulu sebelum menjawab (e.g., model-model "*frontier*" seperti Opus, Kimi, GPT-Sol, Fable, etc.)
...
Bagian awal presentasi tadi fokusnya adalah *literacy*; sisa sesi ini tentang *fluency*.
:::
...
::: {.incremental}
1. ***Problem awareness*** — apa sebenarnya tujuan saya? Seperti apa *output* teks yang baik dan bisa saya terima?
