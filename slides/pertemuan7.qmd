...
* Google AI membuat visualisasi perkembangan produk AI mereka [di sini](https://ai.google/our-ai-journey/?section=intro).
:::
:::
...
## Ironi RLHF: LLM yang terlatih justru *sycophant*
...
## Enam langkah belajar: kerangka penempatan AI
...
::: aside
[Brčić dan Frljić (2026)](https://doi.org/10.48550/arXiv.2606.26181)
:::
...
::: {.incremental}
* Pertanyaan refleksi: di tugas akhir Anda, tahap mana yang harus tetap Anda kerjakan tanpa AI (*Probe* dan *Test*), dan bagaimana Anda tahu kalau AI sudah terlalu dalam mengambil alih tahap itu?
* Pertemuan berikutnya: *AI literacy* dan *AI fluency*, kompetensi yang menjaga kolaborasi manusia-AI ini agar tidak mengarah pada *automation bias*.
:::
